...
import apple from '../Footer/apple.png'
                ...
                <div class="row ">
                    <div class="d-flex">
                        <div class=" col-lg-4">
                            <div class="card" >
                                <div class="foot1">
                                    <h4>Experience Pantaloons App</h4>
                                    <div class="d-flex">
                                        <img src={apple} alt="" />
                                        <img src={android} alt="" />
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card ">
                                ...
                                <div class="d-flex gap-5 foo3">
                                    ...
                                    <div class="foo4">
                                        <p>1800-103-7527 (10am to 10pm)</p>
                                    </div>
                                </div>
                                <div class="d-flex gap-4 foo3">
                                    <div class="d-flex">
                                    ...
                                    <div class="foo4">
                                        <p>customercare@abfrl.adityabirla.com</p>
                                    </div>
                                </div>
                                <div class="withs">
                                ...
                                <div>
                                    <div class="foot5">
                                        ...
                                        </i><input type="email" placeholder="Your Email" />
